...
import { Form, FormField, FormItem, FormLabel, FormControl, FormDescription, FormMessage } from "../../../ui_components/shadn/components/ui/form";
                    ...
                    <div className="rounded-2xl p-8">
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 mt-6">
                            ...
                            <span className="w-full flex justify-end">
                                <Button type="submit" className="bg-gray-800/20 text-xl p-4 w-full md:w-auto">Submit</Button>
                            </span>
                        </form>
                        </Form>
                    </div>
