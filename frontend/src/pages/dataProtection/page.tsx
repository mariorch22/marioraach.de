        ...
        <>
            ...
            <main className="flex items-center lg:p-16 bg-backgroundGray text-white">
                <div className="pt-20">
                    ...
                    <h3 className="text-lg font-semibold py-2">Datenerfassung auf dieser Website</h3>
                    ...
                    <p>
                        ...
                        werden k&ouml;nnen, werden die &uuml;bermittelten Daten auch f&uuml;r Vertragsangebote,
                    ...
                    <p>
                        ...
                        Umst&auml;nden die Einschr&auml;nkung der Verarbeitung Ihrer personenbezogenen Daten
                    ...
                    <h2 className="text-xl font-semibold pt-6">2. Hosting</h2>
                    <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
                    <h3 className="text-lg font-semibold py-2">Amazon Web Services (AWS)</h3>
                    <p>
                    ...
                    <p>
                        ...
                        verarbeitet. Hierbei k&ouml;nnen auch personenbezogene Daten an das Mutterunternehmen von AWS
                        in die USA &uuml;bermittelt werden. Die Daten&uuml;bertragung in die USA wird auf die
                    ...
                    <p>
                        ...
                        auf Informationen im Endgerät des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des TDDDG umfasst.
                    ...
                    <h2 className="text-xl font-semibold pt-6">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
                    <h3 className="text-lg font-semibold py-2">Datenschutz</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold py-2">Hinweis zur verantwortlichen Stelle</h3>
                    ...
                    <p>
                        Telefon: 015209748732
                        <br />
                        E-Mail: marioraach01@gmail.com
                    </p>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold py-2">Speicherdauer</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold py-2">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
                    <p>
                        ...
                        Device-Fingerprinting) eingewilligt haben, erfolgt die Datenverarbeitung zusätzlich auf Grundlage von &sect;
                    ...
                    <h3 className="text-lg font-semibold py-2">Empfänger von personenbezogenen Daten</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold py-2">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold py-2">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold py-2">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
                    <p>
                        Im Falle von Verstößen gegen die DSGVO steht den Betroffenen ein Beschwerderecht bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat ihres gewöhnlichen Aufenthalts, ihres Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes zu. Das Beschwerderecht besteht unbeschadet anderweitiger verwaltungsrechtlicher oder gerichtlicher Rechtsbehelfe.
                    </p>
                    <h3 className="text-lg font-semibold py-2">Recht auf Datenübertragbarkeit</h3>
                    <p>
                        Sie haben das Recht, Daten, die wir auf Grundlage Ihrer Einwilligung oder in Erfüllung eines Vertrags automatisiert verarbeiten, an sich oder an einen Dritten in einem gängigen, maschinenlesbaren Format aushändigen zu lassen. Sofern Sie die direkte Übertragung der Daten an einen anderen Verantwortlichen verlangen, erfolgt dies nur, soweit es technisch machbar ist.
                    </p>
                    <h3 className="text-lg font-semibold py-2">Auskunft, Berichtigung und Löschung</h3>
                    <p>
                        Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung und ggf. ein Recht auf Berichtigung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit an uns wenden.
                    </p>
                    <h3 className="text-lg font-semibold py-2">Recht auf Einschränkung der Verarbeitung</h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold py-2">SSL- bzw. TLS-Verschlüsselung</h3>
                    <p>
                    ...
                    <h2 className="text-xl font-semibold pt-6">4. Plugins und Tools</h2>
                    <h3 className="text-lg font-semibold py-2">Google Fonts</h3>
                    <p>
