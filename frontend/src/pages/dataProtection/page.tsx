    ...
    <>
      <main className="flex items-center lg:p-16">
        <div className="pt-20">
          ...
          <p>
            Anbieter ist die Amazon Web Services EMEA SARL, 38 Avenue John F. Kennedy, 1855
            Luxemburg (nachfolgend AWS).
          </p>
          <p>
            Wenn Sie unsere Website besuchen, werden Ihre personenbezogenen Daten auf den Servern
            von AWS verarbeitet. Hierbei k&ouml;nnen auch personenbezogene Daten an das
            Mutterunternehmen von AWS in die USA &uuml;bermittelt werden. Die Daten&uuml;bertragung
            in die USA wird auf die EU-Standardvertragsklauseln gest&uuml;tzt. Details finden Sie
            hier:{' '}
            <a
          ...
          <p>
            Die Verwendung von AWS erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben
          ...
          <p>
            ...
            erfolgt die Datenverarbeitung zusätzlich auf Grundlage von &sect; 25 Abs. 1 TDDDG. Die
