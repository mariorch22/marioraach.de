...
const styles = {
    footer: 'pt-8',
    divider: 'h-1 w-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-500 via-backgroundGray to-backgroundGray',
    ...
    copyright: 'text-gray-30 text-center text-xs md:text-sm opacity-35 text-md flex flex-col justify-center',
    legalLinks: 'flex gap-2 w-full justify-center'
} as const;

export const FooterLink: React.FC<FooterLinkType> = ({ 
  href, 
  label, 
  ariaLabel, 
  icon: Icon 
