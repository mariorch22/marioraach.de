...
const Arbeitserfahrung: React.FC = () => {
    return (
        <div className='px-2 py-6 md:py-20 md:px-20 text-gray-500 grid gap-8 md:gap-0 md:grid-rows-3 bg-black md:rounded-none rounded-3xl md:rounded-r-3xl md:mt-2 md:mr-2 md:mb-2'>
