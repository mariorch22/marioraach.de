    ...
    <footer className="mt-16 md:mt-24">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          {/* Copyright */}
          <p className="text-sm text-neutral-400">&copy; {new Date().getUTCFullYear()} Mario Raach</p>
          ...
          <ul className="flex items-center gap-4">
            <li>
              <a
                ...
                className="inline-flex items-center text-neutral-400 hover:text-neutral-200 opacity-80 hover:opacity-100 transition-colors"
              >
