...
const Footer = () => {
  ...
  return (
    <FooterPresentation copyrightHolder="Mario Raach" currentYear={currentYear} imprintLabel={FOOTER_LABELS[activeLocale].imprint} dataProtectionLabel={FOOTER_LABELS[activeLocale].dataProtection} />
  );
};
