...
export default async function InfoSection({params, className}: {params: Promise<{locale: string}>, className?: string}) {
    ...
    >
      <div className="space-y-6">
        ...
        <div className="prose prose-lg prose-invert max-w-none">
          <div className="whitespace-pre-line text-gray-100 leading-relaxed text-base sm:text-lg font-roboto 
