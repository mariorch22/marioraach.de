        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="pt-20 pb-12">
                ...
                <div>
                  ...
                  <div className="p-4 rounded-lg mb-3">
                    ...
                    <p className="text-sm sm:text-base text-white mt-2">
                      Telefon: <a href="tel:015209748732" className="text-blue-600 hover:text-blue-800">015209748732</a><br />
                      E-Mail: <a href="mailto:marioraach01@gmail.com" className="text-blue-600 hover:text-blue-800">marioraach01@gmail.com</a>
                    </p>
                  </div>
                  <p className="text-sm sm:text-base text-white leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-semibold mb-2">Google Fonts</h3>
                <div className="space-y-3">
                  <p className="text-sm sm:text-base text-white leading-relaxed">
